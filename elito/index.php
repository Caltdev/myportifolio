...
<body>
    ...
    <div class="page-wrapper">
                            ...
                            <div class="col-xl-6 col-lg-6 col-12">
                                <div class="wpo-static-hero-inner">
                                    ...
                                    <div data-swiper-parallax="300" class="slide-sub-title">
                                        <h5>Software | DevOps Engineer</h5>
                                    </div>
                                    <div data-swiper-parallax="400" class="slide-text">
                                        <p>
                                            A full-stack software engineer specializing in robust, scalable, and
                                            reliable solutions.
                                            I leverage modern technologies to build high-performance applications and
                                            optimized websites,
                                            bridging the gap between clean code and seamless, automated deployment.
                                        </p>
                                    </div>
                    ...
                    <div class="col-lg-6 offset-lg-1 col-md-12 col-sm-12">
                        <div class="wpo-about-content">
                            <div class="wpo-about-title">
                                <h2>Technical Proficiency & Stack</h2>
                                <p>A comprehensive technical toolkit engineered to bridge the gap between development
                                    and operations.
                                    Leveraging production-ready frameworks, modern DevOps practices, and enterprise IT
                                    administration
                                    to build, deploy, and manage robust, highly available systems.</p>
                            </div>

                            <div class="wpo-about-funfact">
                                <!-- Custom grid wrapping the cards to force 3 columns in 2 rows on desktop -->
                                <div class="responsive-tech-grid">
                                    <!-- Box 1 -->
                                    <div class="grid">
                                        <div class="grid-inner">
                                            <h3>Backend</h3>
                                            <p>Django, Node,js & Python</p>
                                        </div>
                                    </div>
                                    <!-- Box 2 -->
                                    <div class="grid">
        ...
        <!-- Add this quick CSS chunk to your style sheet or inside a <style> tag at the top of your document -->
        <style>
